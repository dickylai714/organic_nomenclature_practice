...
practice_problems = [
    ...
    {"smiles": "CC(C)(C)C(C)(C)C", "name": "2,2,3,3-tetramethylbutane", "condensed": "CH3C(CH3)2C(CH3)2CH3", "category": "Branched Alkane", "difficulty": "Hard"},
    {"smiles": "CCCC(CC)CCC", "name": "4-ethylheptane", "condensed": "CH3CH2CH2CH(CH2CH3)CH2CH2CH3", "category": "Branched Alkane", "difficulty": "Hard"},
    ...
    {"smiles": "CC=CC(C)C", "name": "4-methylpent-2-ene", "condensed": "CH3CH=CHCH(CH3)CH3", "category": "Alkene", "difficulty": "Medium"},
    ...
    # Dienes & Trienes
    {"smiles": "C=C=C", "name": "propa-1,2-diene", "condensed": "CH2=C=CH2", "category": "Alkene", "difficulty": "Hard", "alternative_names": ["allene"]},
    {"smiles": "C=CC=C", "name": "buta-1,3-diene", "condensed": "CH2=CHCH=CH2", "category": "Alkene", "difficulty": "Medium"},
    {"smiles": "C=CC=CC", "name": "penta-1,3-diene", "condensed": "CH2=CHCH=CHCH3", "category": "Alkene", "difficulty": "Hard"},
    ...
    {"smiles": "C=CC=CC=C", "name": "hexa-1,3,5-triene", "condensed": "CH2=CHCH=CHCH=CH2", "category": "Alkene", "difficulty": "Hard"},
    {"smiles": "C=CC=CC=CC", "name": "hepta-1,3,5-triene", "condensed": "CH2=CHCH=CHCH=CHCH3", "category": "Alkene", "difficulty": "Hard"},
    ...
    {"smiles": "CI", "name": "iodomethane", "condensed": "CH3I", "category": "Haloalkane", "difficulty": "Easy"},
    {"smiles": "CCCI", "name": "1-iodopropane", "condensed": "CH3CH2CH2I", "category": "Haloalkane", "difficulty": "Medium"},
    {"smiles": "CC(I)C", "name": "2-iodopropane", "condensed": "CH3CHICH3", "category": "Haloalkane", "difficulty": "Medium"},
    ...
    {"smiles": "CC(Cl)(I)C", "name": "2-chloro-2-iodopropane", "condensed": "CH3C(Cl)(I)CH3", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "FC(Cl)I", "name": "chlorofluoroiodomethane", "condensed": "CHFClI", "category": "Haloalkane", "difficulty": "Hard"},
    ...
    {"smiles": "FC(Br)(Cl)C", "name": "1-bromo-1-chloro-1-fluoroethane", "condensed": "CH3CBrClF", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "CC(F)C(Cl)C", "name": "2-chloro-3-fluorobutane", "condensed": "CH3CH(F)CH(Cl)CH3", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "FC(F)(F)C(F)(F)F", "name": "hexafluoroethane", "condensed": "CF3CF3", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "BrC(Br)C(Br)Br", "name": "1,1,2,2-tetrabromoethane", "condensed": "CHBr2CHBr2", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "ClCC(Cl)C(Cl)CCl", "name": "1,2,3,4-tetrachlorobutane", "condensed": "ClCH2CH(Cl)CH(Cl)CH2Cl", "category": "Haloalkane", "difficulty": "Hard"},
    {"smiles": "FC(F)(F)Br", "name": "bromotrifluoromethane", "condensed": "CBrF3", "category": "Haloalkane", "difficulty": "Hard"},
    ...
    # Diols & Triols
    {"smiles": "OCCO", "name": "ethane-1,2-diol", "condensed": "HOCH2CH2OH", "category": "Alkanol", "difficulty": "Medium"},
    ...
    {"smiles": "OCCCCO", "name": "butane-1,4-diol", "condensed": "HOCH2CH2CH2CH2OH", "category": "Alkanol", "difficulty": "Hard"},
    ...
    {"smiles": "OCCCCCCCO", "name": "heptane-1,7-diol", "condensed": "HOCH2(CH2)5CH2OH", "category": "Alkanol", "difficulty": "Hard"},
    ...
    {"smiles": "CC(Cl)C(=O)O", "name": "2-chloropropanoic acid", "condensed": "CH3CH(Cl)COOH", "category": "Carboxylic Acid", "difficulty": "Hard"},
    ...
    # Dioic Acids
    {"smiles": "O=C(O)C(=O)O", "name": "ethanedioic acid", "condensed": "HOOCCOOH", "category": "Carboxylic Acid", "difficulty": "Hard", "alternative_names": ["oxalic acid"]},
    {"smiles": "C(C(=O)O)C(=O)O", "name": "propanedioic acid", "condensed": "HOOCCH2COOH", "category": "Carboxylic Acid", "difficulty": "Hard", "alternative_names": ["malonic acid"]},
    ...
    {"smiles": "O=C(O)CCCC(=O)O", "name": "pentanedioic acid", "condensed": "HOOC(CH2)3COOH", "category": "Carboxylic Acid", "difficulty": "Hard", "alternative_names": ["glutaric acid"]},
    ...
    {"smiles": "O=C(O)CCCCCC(=O)O", "name": "heptanedioic acid", "condensed": "HOOC(CH2)5COOH", "category": "Carboxylic Acid", "difficulty": "Hard", "alternative_names": ["pimelic acid"]},
    {"smiles": "O=C(O)CCCCCCC(=O)O", "name": "octanedioic acid", "condensed": "HOOC(CH2)6COOH", "category": "Carboxylic Acid", "difficulty": "Hard", "alternative_names": ["suberic acid"]},
    ...
    {"smiles": "CC(O)CI", "name": "1-iodopropan-2-ol", "condensed": "ICH2CH(OH)CH3", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "C=CI", "name": "iodoethene", "condensed": "CH2=CHI", "category": "Mixed Functional Groups", "difficulty": "Easy"},
    ...
    {"smiles": "CC(I)C(=O)O", "name": "2-iodopropanoic acid", "condensed": "CH3CH(I)COOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "ClC(Cl)C(=O)O", "name": "2,2-dichloroethanoic acid", "condensed": "Cl2CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "ClC=CC(=O)O", "name": "3-chloropropenoic acid", "condensed": "ClCH=CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "C=C(Cl)C(=O)O", "name": "2-chloropropenoic acid", "condensed": "CH2=C(Cl)COOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "BrCC=CC(=O)O", "name": "4-bromobut-2-enoic acid", "condensed": "BrCH2CH=CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "C=C(Cl)C(C)(O)C", "name": "3-chloro-2-methylbut-3-en-2-ol", "condensed": "CH2=C(Cl)C(CH3)(OH)CH3", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "CC(I)C=C", "name": "3-iodobut-1-ene", "condensed": "CH3CH(I)CH=CH2", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "O=C(O)C=CC(=O)O", "name": "butenedioic acid", "condensed": "HOOCCH=CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "C=C(Cl)C=C", "name": "2-chlorobuta-1,3-diene", "condensed": "CH2=C(Cl)CH=CH2", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "ClC=CCCl", "name": "1,3-dichloropropene", "condensed": "ClCH=CHCH2Cl", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "C=C(C)C(=O)O", "name": "2-methylpropenoic acid", "condensed": "CH2=C(CH3)COOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    {"smiles": "ClCC(O)C=C", "name": "1-chlorobut-3-en-2-ol", "condensed": "CH2=CHCH(OH)CH2Cl", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "O=C(O)C=CC(=O)O", "name": "but-2-enedioic acid", "condensed": "HOOCCH=CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "O=C(O)C=CC=CC=CC(=O)O", "name": "octa-2,4,6-trienedioic acid", "condensed": "HOOCCH=CHCH=CHCH=CHCOOH", "category": "Mixed Functional Groups", "difficulty": "Hard"},
    ...
    {"smiles": "O=CC=O", "name": "ethanedial", "condensed": "OHCCHO", "category": "Aldehyde & Ketone", "difficulty": "Hard", "alternative_names": ["glyoxal"]},
    {"smiles": "O=CCCC=O", "name": "butanedial", "condensed": "OHCCH2CH2CHO", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "O=CCCCC=O", "name": "pentanedial", "condensed": "OHC(CH2)3CHO", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "O=CCCCCC=O", "name": "hexanedial", "condensed": "OHC(CH2)4CHO", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "O=CCCCCCC=O", "name": "heptanedial", "condensed": "OHC(CH2)5CHO", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    ...
    {"smiles": "CC(=O)C(=O)C", "name": "butane-2,3-dione", "condensed": "CH3COCOCH3", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "CC(=O)CC(=O)C", "name": "pentane-2,4-dione", "condensed": "CH3COCH2COCH3", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "CC(=O)CCC(=O)C", "name": "hexane-2,5-dione", "condensed": "CH3COCH2CH2COCH3", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "CCC(=O)CC(=O)CC", "name": "heptane-3,5-dione", "condensed": "CH3CH2COCH2COCH2CH3", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    {"smiles": "CC(=O)CC(=O)CC(=O)C", "name": "heptane-2,4,6-trione", "condensed": "CH3COCH2COCH2COCH3", "category": "Aldehyde & Ketone", "difficulty": "Hard"},
    ...
    {"smiles": "NCCN", "name": "ethane-1,2-diamine", "condensed": "H2NCH2CH2NH2", "category": "Primary Amine", "difficulty": "Hard", "alternative_names": ["ethylenediamine"]},
    {"smiles": "NCCCN", "name": "propane-1,3-diamine", "condensed": "H2NCH2CH2CH2NH2", "category": "Primary Amine", "difficulty": "Hard"},
    {"smiles": "NCCCCN", "name": "butane-1,4-diamine", "condensed": "H2N(CH2)4NH2", "category": "Primary Amine", "difficulty": "Hard", "alternative_names": ["putrescine"]},
    {"smiles": "NCCCCCN", "name": "pentane-1,5-diamine", "condensed": "H2N(CH2)5NH2", "category": "Primary Amine", "difficulty": "Hard", "alternative_names": ["cadaverine"]},
    {"smiles": "NCCCCCCN", "name": "hexane-1,6-diamine", "condensed": "H2N(CH2)6NH2", "category": "Primary Amine", "difficulty": "Hard"},
    {"smiles": "NCC(N)CN", "name": "propane-1,2,3-triamine", "condensed": "H2NCH2CH(NH2)CH2NH2", "category": "Primary Amine", "difficulty": "Hard"},
    ...
    {"smiles": "NC(=O)C(=O)N", "name": "ethanediamide", "condensed": "H2NCOCONH2", "category": "Unsubstituted Amide", "difficulty": "Hard"},
    {"smiles": "NC(=O)CC(=O)N", "name": "propanediamide", "condensed": "H2NCOCH2CONH2", "category": "Unsubstituted Amide", "difficulty": "Hard"},
    {"smiles": "NC(=O)CCC(=O)N", "name": "butanediamide", "condensed": "H2NCO(CH2)2CONH2", "category": "Unsubstituted Amide", "difficulty": "Hard"},
    {"smiles": "NC(=O)CCCC(=O)N", "name": "pentanediamide", "condensed": "H2NCO(CH2)3CONH2", "category": "Unsubstituted Amide", "difficulty": "Hard"},
    {"smiles": "NC(=O)CCCCC(=O)N", "name": "hexanediamide", "condensed": "H2NCO(CH2)4CONH2", "category": "Unsubstituted Amide", "difficulty": "Hard"},
    ...
    {"smiles": "CCCC(=O)OC", "name": "methyl butanoate", "condensed": "CH3CH2CH2COOCH3", "category": "Ester", "difficulty": "Medium"},
    {"smiles": "CCCCC(=O)OC", "name": "methyl pentanoate", "condensed": "CH3(CH2)3COOCH3", "category": "Ester", "difficulty": "Hard"},
    {"smiles": "CCC(=O)OCCC", "name": "propyl propanoate", "condensed": "CH3CH2COOCH2CH2CH3", "category": "Ester", "difficulty": "Hard"},
    {"smiles": "CC(=O)OCCCC", "name": "butyl ethanoate", "condensed": "CH3COOCH2CH2CH2CH3", "category": "Ester", "difficulty": "Hard"},
    {"smiles": "COC(=O)C(=O)OC", "name": "dimethyl ethanedioate", "condensed": "CH3OOCCOOCH3", "category": "Ester", "difficulty": "Hard", "alternative_names": ["dimethyl oxalate"]},
    {"smiles": "COC(=O)CC(=O)OC", "name": "dimethyl propanedioate", "condensed": "CH3OOCCH2COOCH3", "category": "Ester", "difficulty": "Hard", "alternative_names": ["dimethyl malonate"]},
    {"smiles": "CCOC(=O)CCC(=O)OCC", "name": "diethyl butanedioate", "condensed": "CH3CH2OOCCH2CH2COOCH2CH3", "category": "Ester", "difficulty": "Hard", "alternative_names": ["diethyl succinate"]},
]